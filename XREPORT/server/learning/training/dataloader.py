...
class XRAYDataLoader:
            ...
            transform_list.extend(
                [
                    ...
                    transforms.RandomApply(
                        [transforms.ColorJitter(brightness=0.2, contrast=0.2)], p=0.25
                    ),
                ]
            )
        else:
    ...
    # -------------------------------------------------------------------------
    def prepare_inference_image(self, image_path: str) -> np.ndarray:
    ...
    def build_training_dataloader(
        ...
        dataset = XRAYDataset(data, training=True, image_transform=training_transforms)
    ...
    def build_inference_dataloader(
        ...
        inference_transforms = self._get_transforms(training=False)
        dataset = XRAYDataset(
            data, training=False, image_transform=inference_transforms
        )
