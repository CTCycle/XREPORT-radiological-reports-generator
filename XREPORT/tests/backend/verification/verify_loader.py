...
def verify_loader():
    ...
    from XREPORT.server.utils.learning.validation import validation_wizard
    ...
    import XREPORT.server.utils.learning.training.dataloader as dl_module
    ...
    assert inputs.dtype == torch.int64, f"Input dtype should be int64, got {inputs.dtype}"
    assert outputs.dtype == torch.int64, f"Output dtype should be int64, got {outputs.dtype}"
