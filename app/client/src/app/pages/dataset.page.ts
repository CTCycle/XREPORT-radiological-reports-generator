...
@Component({
  ...
  imports: [CommonModule, FormsModule, NgIcon, ImageViewerComponent, ModalFocusDirective, ValidationReportModalComponent, ValidationWizardComponent, FeatureTipComponent, HelpPopoverComponent],
