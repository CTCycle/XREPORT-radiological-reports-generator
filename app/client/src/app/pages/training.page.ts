...
export class TrainingPage {
  ...
  private pollTraining(jobId: string) {
    ...
    this.polling.poll((id) => this.api.getTrainingJobStatus(id), jobId, 2).pipe(takeUntilDestroyed(this.destroyRef)).subscribe((status) => {
