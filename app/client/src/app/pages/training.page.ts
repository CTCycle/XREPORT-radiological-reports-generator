...
@Component({
  ...
  template: `
    <div class="training-guidance-helper"><span>Checkpoint actions</span><app-help-popover label="Explain checkpoint actions" title="Checkpoint actions" body="Resume continues a saved training state. Evaluate Model runs a separate inspection of the selected checkpoint; metadata and reports can be reopened later." /></div>
