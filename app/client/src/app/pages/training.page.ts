...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, NgIcon, CheckpointEvaluationReportModalComponent, EvaluationWizardComponent, ModalFocusDirective, NewTrainingWizardComponent, TrainingDashboardComponent],
