...
- Current application source revision: `37a4b78e6ca939f8a2b6cb9e29c8fa7d46a3d41e`; current validation/test revision: `2c1825645f7dffbbd669cfa58f7ced5ebc783bdc` (`develop`). Hosted run `35865126628` passed all configured gates on the validation/test revision, including client unit tests. It resolves the repeated desktop-dialog failures from runs `35862434438` and `35860925179`; the test now stubs the Tauri runtime bridge and exercises the installed Tauri APIs. The Windows focused spec passed (`3 passed`) and full client unit suite passed (`39 passed`). S00 and S03 are `PASS` at this Tier 0 gate scope. Earlier same-code revision `16794b4` also passed all stages on rerun `35859367232`. S20's focused API/service suite passed locally (`12 passed`); see the [S20 summary](../QA/validation_campaign/s20/summary-20260923.md). S02 remains covered by the [2026-09-23 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260923.md).
