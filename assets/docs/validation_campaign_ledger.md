...
- Current application source and validation/test revision: `37a4b78e6ca939f8a2b6cb9e29c8fa7d46a3d41e` (`develop`). The pushed ledger/evidence revision is `16794b40948badfb1af4e4705048d1e6a56e5376`; hosted CI run `35859367232` passed all configured gates on that SHA after the same-SHA failed-job rerun. The initial attempt failed two client desktop-dialog assertions; the rerun passed. S20's focused API/service suite passed locally (`12 passed`); see the [S20 summary](../QA/validation_campaign/s20/summary-20260923.md). S02 remains covered by the [2026-09-23 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260923.md).
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `S00` | Restore current CI baseline | yes | yes | `PASS` | Hosted workflow run `35859367232` passed all configured gates on pushed revision `16794b4`, a docs/evidence-only descendant of S20 source/test revision `37a4b78`. Its initial attempt failed two client desktop-dialog assertions; the failed-job rerun passed the backend, database, API, build, lint, and client test stages on the same SHA. | [2026-09-22 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260922.md); [CI run 35859367232](https://github.com/CTCycle/XREPORT-radiological-reports-generator/actions/runs/35859367232) | — |
...
| `S03` | Static quality, API contract, and client build gates | yes | yes | `PASS` | Hosted CI run `35859367232` passed Ruff, Pyright, client build, client lint, and client unit tests; it also passed the backend suite, PostgreSQL contract, and retained API E2E on the pushed revision. Current-scope local Windows production build and rendered checks remain in the dated execution summary. | [2026-09-22 execution summary](../QA/validation_campaign/tier-0/summary-20260922.md); [CI run 35859367232](https://github.com/CTCycle/XREPORT-radiological-reports-generator/actions/runs/35859367232) | — |
