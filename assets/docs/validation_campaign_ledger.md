...
- Current application source and validation/test revision: `37a4b78e6ca939f8a2b6cb9e29c8fa7d46a3d41e` (`develop`). The focused S20 API/service suite passed locally (`12 passed`); see the [S20 summary](../QA/validation_campaign/s20/summary-20260923.md). Hosted CI run `35841152401` passed all configured gates on the prior revision `f6ee0a9dacf4b024cf2b8cea75c6f025c2dc7d63`; the hosted recheck on the S20 revision is pending. S02 remains covered by the [2026-09-23 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260923.md).
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `S00` | Restore current CI baseline | yes | yes | `PARTIAL` | The isolated concurrency/import test passed through ten fresh subprocesses; complete hosted workflow run `35841152401` passed on revision `f6ee0a9`. The current source/test revision `37a4b78` has focused local S20 coverage, but hosted CI has not yet rerun on it. | [2026-09-22 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260922.md); [CI run 35841152401](https://github.com/CTCycle/XREPORT-radiological-reports-generator/actions/runs/35841152401) | Rerun hosted CI on the current S20 source/test revision before restoring the current-baseline `PASS`. |
...
| `S03` | Static quality, API contract, and client build gates | yes | yes | `PASS` | Hosted CI passed Ruff, Pyright, client build, client lint, and client unit tests; it also passed the backend suite, PostgreSQL contract, and retained API E2E on the current validation revision. Current-scope local Windows production build and rendered checks remain in the dated execution summary. | [2026-09-22 execution summary](../QA/validation_campaign/tier-0/summary-20260922.md); [CI run 35841152401](https://github.com/CTCycle/XREPORT-radiological-reports-generator/actions/runs/35841152401) | — |
