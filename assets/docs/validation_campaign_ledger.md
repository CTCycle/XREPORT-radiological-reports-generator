...
- Current application source and validation/test revision: `37a4b78e6ca939f8a2b6cb9e29c8fa7d46a3d41e` (`develop`). The latest pushed ledger/evidence revision is `5cbe2a7c86ec828ff8d9cecd35a55b94f9e9d0e3`. Hosted CI run `35860925179` failed the client unit stage on that docs-only descendant; its same-SHA failed-job rerun reproduced two desktop-dialog assertions. Backend, PostgreSQL, API, client build/server, and lint stages passed. Earlier same-code revision `16794b4` passed all stages on rerun `35859367232`. S20's focused API/service suite passed locally (`12 passed`); see the [S20 summary](../QA/validation_campaign/s20/summary-20260923.md). S02 remains covered by the [2026-09-23 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260923.md).
