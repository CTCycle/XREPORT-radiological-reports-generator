...
- Current application source and validation/test revision: `f6ee0a9dacf4b024cf2b8cea75c6f025c2dc7d63` (`develop`). Hosted CI run `35841152401` passed all configured gates on this revision. S02 was refreshed on the current startup source with the focused readiness scenario and rendered screenshots; the durable result is in the [2026-09-23 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260923.md).
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `S00` | Restore current CI baseline | yes | yes | `PASS` | The isolated concurrency/import test passed through ten fresh subprocesses; the complete backend unit suite passed locally and in hosted CI. All hosted workflow stages passed on the current validation revision, including PostgreSQL, API E2E, client build/server, lint, and client unit tests. | [2026-09-22 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260922.md); [CI run 35841152401](https://github.com/CTCycle/XREPORT-radiological-reports-generator/actions/runs/35841152401) | — |
