...
- Latest committed application and validation/test revision before the current follow-up: `37a4b78e6ca939f8a2b6cb9e29c8fa7d46a3d41e` (`develop`). Latest pushed revision `caa4a4144be9b54bc762df4c054a82fee21ec99b` failed hosted run `35862434438` in the client unit stage; two desktop-dialog assertions also failed in earlier run `35860925179`. The other configured stages passed. The current working-tree repair replaces ineffective module mocks with Tauri runtime bridge stubs. Its focused desktop-dialog spec passed locally (`3 passed`) and the complete client unit suite passed (`39 passed`); hosted CI on the committed repair is still required before S00/S03 can pass. Earlier same-code revision `16794b4` passed all stages on rerun `35859367232`. S20's focused API/service suite passed locally (`12 passed`); see the [S20 summary](../QA/validation_campaign/s20/summary-20260923.md). S02 remains covered by the [2026-09-23 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260923.md).
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `S00` | Restore current CI baseline | yes | yes | `PARTIAL` | Latest pushed revision `caa4a41` failed hosted run `35862434438` in client unit tests; the same two desktop-dialog assertions failed in run `35860925179`. The current working-tree bridge-stub repair passes the focused spec (`3 passed`) and complete client suite (`39 passed`) locally; hosted CI on the committed repair remains outstanding. Earlier same-code revision `16794b4` passed all stages on run `35859367232` after rerun. | [2026-09-23 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260923.md); [failed current CI run 35862434438](https://github.com/CTCycle/XREPORT-radiological-reports-generator/actions/runs/35862434438); [previous failed run 35860925179](https://github.com/CTCycle/XREPORT-radiological-reports-generator/actions/runs/35860925179); [prior green run 35859367232](https://github.com/CTCycle/XREPORT-radiological-reports-generator/actions/runs/35859367232) | Push the tested repair and rerun all hosted gates; keep S00 partial until they pass. |
...
| `S03` | Static quality, API contract, and client build gates | yes | yes | `PARTIAL` | Hosted run `35862434438` on `caa4a41` passed Ruff, Pyright, backend unit tests, PostgreSQL contract, API E2E, client build/server, and lint; it failed the client unit stage on the two desktop-dialog cases. The repaired spec now exercises the real Tauri packages using stubbed runtime bridge globals; local focused tests passed (`3 passed`) and the complete client suite passed (`39 passed`). The same-code revision `16794b4` had a green rerun, but the latest hosted baseline remains red until the repair is pushed and all hosted gates pass. Current-scope local production build and rendered checks remain in the dated execution summary. | [2026-09-23 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260923.md); [current CI run 35862434438](https://github.com/CTCycle/XREPORT-radiological-reports-generator/actions/runs/35862434438); [2026-09-22 execution summary](../QA/validation_campaign/tier-0/summary-20260922.md) | Push the repair and rerun all hosted gates; keep S03 partial until they pass. |
