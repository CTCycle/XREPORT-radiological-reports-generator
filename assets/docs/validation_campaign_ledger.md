...
- Current application source revision: `fdb4a8bf9af37eadea648851cb1a0b54e187f7b3`; validation/test revision: `906b455d90c4a938704a8a62d843455d75ab41fe` (`develop`). Hosted CI run `35834323975` passed on the validation revision. S02 was refreshed on the current source with the focused readiness scenario and rendered screenshots; the durable result is in the [2026-09-23 Tier 0 summary](../QA/validation_campaign/tier-0/summary-20260923.md).
