...
- S30 and S32 passed on 2026-09-24 after 55 focused inference unit tests, six live API E2E tests, Ruff, and saved rendered-browser catalogue screenshots. That campaign fixed unbounded endpoint-side upload copying and isolated a catalogue-test monkeypatch leak. S31 then passed a fresh public-model download, single-file repair, real inference/readiness promotion, restart reuse without redownload, deletion, history preservation, and canonical-snapshot offline reload against current source commit `80e8d7a`. S33 remains untested because the rendered Generate/review states were not exercised in this slice. S28 remains untested for missing encoder/checkpoint prerequisites; S35 remains failed/degraded for missing approved fixtures and two distinct reports across three historical cases; S37 remains blocked for missing gated access. See the [S31 summary](../QA/validation_campaign/s31/summary-20260924.md), its [prerequisite recheck](../QA/validation_campaign/s31/prerequisite-recheck-20260924.json), and the [S30–S32 summary](../QA/validation_campaign/s30-s32-20260924/summary.md).
...
| `S31` | Lightweight public-model installation lifecycle | `S30` | `PASS` | Revalidated current implementation on 2026-09-24 with exact pinned CXRMate Multi: remote install/staging, one-file corruption and repair, real inference readiness promotion, stop/restart with unchanged snapshot and no redownload, delete with positive bytes freed, persistent inference history, and offline reload of untouched canonical snapshot all passed. Scope is one open model and one public image; this is technical lifecycle evidence, not quality or clinical validation. [S31 summary](../QA/validation_campaign/s31/summary-20260924.md) and linked job, snapshot, fixture, and reload evidence; [S28/S35/S37 prerequisite recheck](../QA/validation_campaign/s31/prerequisite-recheck-20260924.json). |
...
| `S33` | Complete browser inference workflow | `S31`, `S32` | `UNTESTED` | Next actionable inference slice: rendered Generate, poll, cancel, retry, edit, copy, export, provenance, and persistence against an installed model. S31's real API generation does not substitute for rendered browser evidence. The public fixture was not uploaded through the browser in this tranche; get explicit approval before exercising the UI upload path. |
...
| `S35` | CXRMate-ED sensitivity canary | `S31` | `FAIL` / degraded | Rechecked 2026-09-24: live catalogue status remains `degraded`; the historical three-case run completed but produced only two distinct reports. Its exact approved fixture directory is absent, so no substitutes were run and promotion remains unjustified. [S31 prerequisite recheck](../QA/validation_campaign/s31/prerequisite-recheck-20260924.json); [historical canary](../QA/inference_validation_runs/cxrmate-ed-sensitivity-20260919T154916Z.json). |
...
| `S37` | MedGemma gated-provider behavior | `S30` | `BLOCKED` | Rechecked 2026-09-24: the live catalogue reports `access_policy=gated`; no nonempty `HF_TOKEN` is configured in the validation process or `settings/.env`. No install or generation was attempted. Continue blocked until authorized access is configured. [S31 prerequisite recheck](../QA/validation_campaign/s31/prerequisite-recheck-20260924.json); [live API response](../QA/validation_campaign/s30-s32-20260924/catalog-api.json). |
